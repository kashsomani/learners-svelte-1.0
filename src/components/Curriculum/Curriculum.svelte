...
<div
  ...
  class="px-12 md:px-20 my-10 grid grid-cols-1 place-items-center"
>
  <h2>Curriculum:</h2>
  <div class="grid grid-cols-1  md:grid-cols-2  place-items-stretch gap-6 ">
    <div class="text-center py-2 px-8 card rounded-lg my-6 ">
    ...
    <div class=" text-center py-2 px-8 card rounded-lg my-6 ">
      ...
      <div class="grid grid-cols-1 place-items-center">
        <ul class="text-lg ">
          ...
          <li>Computer / Coding</li>
          <li>Value Education</li>
          <li>Socially Useful Productive Work (S.U.P.W)</li>
    ...
    >
      ...
      <ul class="text-lg ">
        ...
        <li>Hindi</li>
        <li>French</li>
        <li>Marathi (STD VI - VII)</li>
        <li>Math</li>
        <li>Science (STD VII - VIII)</li>
        ...
        <li>
          <div>
            ...
            <ul>
              ...
              <li>History, Civics and Geography - Paper I</li>
              <li>History, Civics and Geography - Paper II</li>
            </ul>
          </div>
        </li>
        <li>
          <div>
            <div class="p-1">
              ...
              <ul>
                ...
                <li>Mathematics and Commercial Studies</li>
                <li>Commercial Studies and Envioronmental Science</li>
              </ul>
            </div>
            <div class="p-1">
              <h4>Group III</h4>
...
<style lang="postcss">
  ...
  .card {
    border-radius: 72px;
    background: #94f09a;
    box-shadow: 17px 17px 34px #6eb272, -17px -17px 34px #baffc2;
  }
</style>
