...
<div in:fly={{duration:2000}}>
    <TeachingFacultySection heading="Academic Management" teachers={academicManagementData}/>
    
    <TeachingFacultySection heading="Teaching Faculty" teachers={teachingFacultyData}/>
